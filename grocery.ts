class Grocery {
    ...
    constructor(name: string, itemNo: number, price: number, quantity: number, brand: string){
        this.name = name;
        this.itemNo = itemNo;
        this.price = price;
...
let groceryList: Array<Grocery> = [new Grocery("Chocolate", 10279954, 13.50, 5, "Hershey's"), new Grocery("Apples", 10584922, 13.50, 12, "Delicous"), new Grocery("Milk", 15842654, 32.29, 5, "White Yummy's"), new Grocery("Soup", 84059887, 60.88, 20, "Creamy's"), new Grocery("Cereal", 46517800, 16.50, 4, "Crunchy's")];
